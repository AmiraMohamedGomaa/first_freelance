package com.amira.freelance.sefat.model.has_ded_model;

public class Etbaq {
    public static String title="7-الإطـبـاق";
    ...
    public static String title2="8-الإنـفـتـاح";
    public static String loqtan2="التجافي و الافتراق";
    public static String estlah2="عدم إلصاق اللسان بالحنك الأعلى عند النطق بحروفه فلا ينحصر الصوت بينهما";
    public static String horof2="بقية الحروف بعد حروف الإطباق";
